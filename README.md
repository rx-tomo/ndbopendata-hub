...
| **ChatGPT Connect（MCP）** | Remote MCP として `https://ndbopendata-hub.com/api/mcp` を登録 | **OpenAI がベータ提供中（2025-10時点）**。個人は Developer Mode を ON、組織は管理者許可が前提。不安定な場合は Actions 経由に切り替え推奨。設定手順: <https://ndbopendata-hub.com/mcp/bridge#connect> |
